...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  PRIMARY KEY (`aemail`)
) ENGINE=MyISAM DEFAULT CHARSET=english1;
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=english1;
...
CREATE TABLE IF NOT EXISTS `patient` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=english1;
...
CREATE TABLE IF NOT EXISTS `schedule` (
  ...
  KEY `docid` (`docid`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=english1;
